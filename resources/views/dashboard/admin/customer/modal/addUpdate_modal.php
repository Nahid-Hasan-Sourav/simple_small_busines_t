...
<div class="modal fade" id="customerAddUpdateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="width: 60%;">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" value="" id="addUpdateCustomerBtn" class="btn btn-primary">ADD CUSTOMER</button>
      </div>
    </div>
  </div>
</div>